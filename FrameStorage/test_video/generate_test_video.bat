...
ffmpeg -y -loop 1 -i img_white.png -c:v libx264 -t 5 -pix_fmt yuv420p -s 320x240 -vf "drawtext=text='%%{n}'" tst_r24_264.mp4

@REM ffmpeg -y -loop 1 -i img_white.png -r 10000 -c:v libx264 -t 15 -pix_fmt yuv420p -s 320x240 tst_r10000_264.mp4
@REM ffmpeg -y -i tst_r10000_264.mp4 -vf "drawtext=text='%%{n}'" tst_r10000_264_txt.mp4

ffmpeg -y -loop 1 -i img_white.png -r 100 -c:v libx264 -t 15 -pix_fmt yuv420p -s 320x240 tst_r100_264.mp4
ffmpeg -y -i tst_r100_264.mp4 -vf "drawtext=text='%%{n}'" tst_r100_264_txt.mp4
